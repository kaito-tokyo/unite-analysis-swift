...
@Test func baselineJPEGMetadataFilterPreservesICCAndFillBytes() throws {
  let jpeg = Data([
    0xFF, 0xD8,
    0xFF, 0xE0, 0x00, 0x04, 0x4A, 0x46,
    0xFF, 0xFF, 0xE2, 0x00, 0x04, 0x49, 0x43,
    0xFF, 0xE1, 0x00, 0x04, 0x45, 0x58,
    0xFF, 0xFF, 0xDA, 0x00, 0x02,
    0x12, 0x34, 0xFF, 0xD9,
  ])

  let filtered = try VideoFrameSupport.removingAPP1Metadata(from: jpeg)
