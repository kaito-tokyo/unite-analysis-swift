...
package struct UniteAnalysisSwiftCommand: ParsableCommand {
  package static let configuration = CommandConfiguration(
    ...
    discussion: """
      ...
      `asr-v1 --help`, `event-detect-v1 --help`,
      `audio-peaks-v1 --help`, `detect-matches-v1 --help`, `extract-clip --help`, `ocr-v1 --help`, `scan-result-v1 --help`,
    ...
    subcommands: [
      ...
      FrameBurst.self,
      DetectChromaEvents.self, AudioPeaks.self, ASRCommand.self, DetectMatches.self,
      EventDetect.self,
